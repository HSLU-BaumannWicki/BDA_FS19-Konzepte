...
\graphicspath{{./Erstes_Konzept/img/}{./Erstes_Konzept/pdf/}}
...
\begin{titlepage}
	\begin{center}
		...
		\vspace{0.5em}
		\Huge{Konzept zur Auffindung eines deplatzierten Exemplars im Hochregallager }\\
		\vspace{3em}
...
\include{Erstes_Konzept/Erstes_Konzept}
