...
\graphicspath{{./Zweites_Konzept/img/}{./Zweites_Konzept/pdf/}}
...
\begin{titlepage}
	\begin{center}
		...
		\vspace{0.5em}
		\Huge{Konzept zur Verhinderung des Deplatzieren eines Exemplars vor Einlagerung in das Hochregallager}\\
		\vspace{3em}
...
\include{Zweites_Konzept/Zweites_Konzept}
