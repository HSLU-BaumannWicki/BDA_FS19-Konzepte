...
\subsection{BehälterID über Lagerverwaltungssystem}
Eine direkte Einbindung in das Lagerverwaltungssystem würde ermöglichen, dass dieses weiss welcher Behälter nun zur Scanstation kommt und was dessen ID plus Inhalt sein sollte.

\begin{itemize}
	\pro BehälterID und ExemplarID kommen direkt vom Lagerverwaltungssystem
	\item Schnittstelle zu Lagerverwaltungssystem muss definiert werden
	\con Engere Abhängigkeit vom Lagerverwaltungssystem
	\con Lagerverwaltungssystem muss um neue Station erweitert werden
\end{itemize}
